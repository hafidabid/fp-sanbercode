...
@section('button1')
<a href="{{ url('/pertanyaan/') }}"><button type="button"
        class="btn btn-block btn-danger btn-sm">Back to front</button></a>
@endsection
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Enter ..." id="isi"
                        name="isi">{{ $pertanyaanku->isi }}</textarea>
                </div>
            </div>
        </div>
